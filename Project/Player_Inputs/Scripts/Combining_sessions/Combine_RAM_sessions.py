...
def main():
    ...
    directory = "/home/bryan/dissertation/Project/Player_Inputs/Dataset/winning/YoshiIsland2"
    ...
    #np.save('/home/bryan/dissertation/Project/Player_Inputs/Dataset/Combined_Dataset', L1_combined_session_data)

...
def split(x, y):
    ...
    if (isinstance(x, np.ndarray)): # if left side is a terminal node (action)
        arr.append(x) # add action to return array
    else:
        for action in x: # if the left side is an array, loop trought it
            arr.append(action) # add each action to the return array

    if (isinstance(y, np.ndarray)): # if the right side is a terminal node
        arr.append(y) # add action to return array
    else:
        for action in y: # if the right side is an array, loop trought it
            arr.append(action) # add each action to the return array
